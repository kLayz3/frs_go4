...
void setup_sXXX_YYY_2024_attemptToRediscoverPars()
{
...
return;
 ...
 /*
  ...
  frs->bfield[0] = 7.1741;    // 205Pb, eng run  
  frs->bfield[1] = 6.7626;    // 205Pb, eng run
  frs->bfield[2] = 8.8181;   //  205Pb, eng run 
  frs->bfield[3] = 8.806;   //  205Pb, eng run
