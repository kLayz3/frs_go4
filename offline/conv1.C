...
int main(int argc, char *argv[])
{
  ...
  for(int i=0;i<t->GetEntries();i++)
      ...
      for (int j=0;j<640;j++)
	{
      ...
      std::copy(B1,B1+640,A1);std::copy(B2,B2+640,A2);
      std::copy(B3,B3+640,A3);std::copy(B4,B4+640,A4);
      std::copy(B5,B5+640,A5);std::copy(B6,B6+640,A6);
      std::copy(B7,B7+640,A7);std::copy(B8,B8+640,A8);
